...
class listsHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        conn.commit()
        self.render("sangao_admin\\templates\\Design\\lists.html",designs=designs)
...
class checkPassHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        # 统计模块结束
        conn = sqlite3.connect("D:\\projects3\\db\\sangao.db")
        sql = "update design set isChecked=1 where id="+self.get_argument("id")
        designs = conn.cursor().execute(sql)
        conn.commit()
        self.write("修改成功！")
...
class addHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        self.render("sangao_admin/templates/Design/add.html")
    def post(self):
        # 上传文件的处理
        UPLOAD_FILE_PATH = 'sangao_admin\\templates\\Design\\upload\\'
        ...
        sql = "insert into design(name,path,isChecked) values('" + data[
            "name"] + "' \
        	,'" + data["filepath"] + "',0)"
        print("sql语句:" + sql)
        conn = sqlite3.connect("D:\\projects3\\db\\sangao.db")
...
class editHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        print(design)
        self.render("sangao_admin/templates/Design/edit.html"
                    , design=design
                    )
...
class doubleEditHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        self.render("sangao_admin/Learn/templates/edit.html"
    ...
    def post(self):
        ...
        url1 = "http://192.168.43.1:8000/sangao_admin/Learn/Home/Index/edit?id=" + self.get_argument("id")
        url123 = "http://127.0.0.1:8000/sangao_admin/Learn/edit?id=" + self.get_argument("id")
        url_test = "http://192.168.43.1:8080/sangao_admin/Learn/index.php?m=Home&c=index&a=doubleedit&id=" + self.get_argument("id")
...
class selectHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        self.render("sangao_admin/Learn/templates/select.html"
    ...
    def post(self):
        ...
        self.render("sangao_admin/Learn/templates/result.html"
                    , tasks=tasks)
        #	       #conn.
        '''
